...
function sendMessage($fp, $msg) {
  $xml = "<message
       to='bdoherty92@chat.facebook.com'
       from='mdierker@chat.facebook.com'
       xml:lang='en'>
     <body>$msg</body>
   </message>";
  send_xml($fp, $xml);
...
function _main() {
  ...
  $my_url = "http://schedule.eatcumtd.com/chat.php";
  $uid = $_GET['id'];
